...
<?php
class Modelbillreading extends Model {
	
	public function editreading($reading_id, $data) {
		//   die("ki");
		//   die("UPDATE " . DB_PREFIX . "reading SET reading_limit = '" . $this->db->escape($data['config_reading_limit'])  . "' WHERE reading_id = '" . (int)$reading_id . "'")
		$this->db->query("UPDATE " . DB_PREFIX . "reading SET reading_limit = '" . $this->db->escape($data['config_reading_limit'])  . "' WHERE reading_id = '" . (int)$reading_id . "'");

		//  $this->cache->delete('reading');
	}
	...
	public function getStores($data = array()) {
		$store_data = $this->cache->get('reading');

		if (!$store_data) {
			$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "reading");
			// print_r($query);die;
	...
	public function getTotalStores() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "reading");
		// print_r($query);die;
